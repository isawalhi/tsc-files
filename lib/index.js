...
const { resolveFromModule, resolveFromRoot, getChangedFilesErrors, displayErrors } = require('./utils')
...
const tmpTsconfigPath = resolveFromRoot(`tsconfig.autoGenerated.json`)
const tmpTsconfig = {
  ...tsconfig,
  compilerOptions: {
...
const errors = getChangedFilesErrors(stdout.split(/\r?\n/), files)
